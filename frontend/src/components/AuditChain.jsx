      ...
      {chain.map((block, i) => {
        ...
        let previewText = "";
          ...
          if (typeof block.input_data === "string") {
            previewText = block.input_data.slice(0, 60); // raw logs preview
          } else if (Array.isArray(block.input_data)) {
            previewText = JSON.stringify(block.input_data[0]).slice(0, 60);
          } else {
                ...
                <div className="block-detail">
                  ...
                  <pre className="json-pre">
                    {JSON.stringify({
                      ...
                      input_data:
                        typeof block.input_data === "string"
